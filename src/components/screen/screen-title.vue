<template>
  <div class="bb-screen-title">
    <svg width="100%" height="100%" viewBox="0 0 1876 51" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <g id="数据可视化" transform="translate(-35.000000, -12.000000)">
          <g id="编组" transform="translate(35.000000, 10.000000)">
            <g id="编组-44" transform="translate(0.000000, 3.000000)">
              <polyline id="路径" stroke="url(#linearGradient-1)" stroke-width="2" :points="linePoint"></polyline>
